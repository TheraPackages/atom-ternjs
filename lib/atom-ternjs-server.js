...
export default class Server {
  ...
  constructor(projectRoot, client) {
    ...
    this.distDir = this.ternDir(); //path.resolve(__dirname, '../node_modules/tern');
  ...
  getRoot(file) {
    var dir = path.dirname(file), prev;
  ...
  ternDir() {
    let ternPath = require.resolve('tern');
    ternPath = this.getRoot(ternPath);
    return path.normalize(ternPath);
  }
